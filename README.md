# Social-Spenders
Social Spenders is a fullstack application using React as the framework along with MySQL as the backend database, connected with Node.js and Express.js. I decided to build a Social Networking site where users can publicize their thoughts and purchases in the website.
